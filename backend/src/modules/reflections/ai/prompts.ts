...
**핵심 문장 강조 (킬링 문장):**
- 응답에서 가장 위로가 되는 핵심 문장 1~2개를 ==문장== 형식으로 감싸주세요.
- 이 문장은 사용자가 가장 기억에 남을 따뜻한 한 마디여야 합니다.
- 예시: ==당신이 이렇게 돌아보고 반성할 만큼 깊이 아이를 사랑하는 분이에요.==
- 전체 응답 중 최대 2문장만 강조하세요. 남용하면 효과가 줄어듭니다.`;
